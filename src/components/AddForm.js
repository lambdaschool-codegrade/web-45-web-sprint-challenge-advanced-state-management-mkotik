...
import { addErrorMsg, addSmurf } from "../actions";
...
const AddForm = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (state.name === "" || state.position === "" || state.nickname === "") {
      ...
      props.addErrorMsg("Name, position, and nickname fields are required.");
    } else {
...
export default connect(mapStateToProps, { addErrorMsg, addSmurf })(AddForm);
